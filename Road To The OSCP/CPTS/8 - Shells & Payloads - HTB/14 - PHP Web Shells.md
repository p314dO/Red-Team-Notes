El preprocesador de hipertexto o [PHP](https://www.php.net) es un lenguaje de programación de código abierto y de propósito general que normalmente se utiliza como parte de una pila web que impulsa un sitio web.
